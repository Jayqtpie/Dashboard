...
export default function InstagramStatsInput() {
  ...
  const { followersSeries, engagementSeries, yMin, yMax } = useMemo(() => {
    if (!entries.length) {
      return { followersSeries: [], engagementSeries: [], yMin: 0, yMax: 100 };
    }
  ...
  return (
    <Card title="Instagram Stats" subtitle="Manually log followers + engagement and track trend over time.">
